...
try:
    ...
    print(str(e))
    invokeapi.Invoke_Pipeline(args.pipeline_pat,args.env_selection,args.build_number,args.org_name, args.project_name, args.error_pipeline_definition_number, args.error_pipeline_version_number,args.azdo_pipeline_rest_version, str(e), "Transform")
    raise