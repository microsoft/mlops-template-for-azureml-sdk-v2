...
To support the extension, you need to setup a new Azure Resource Manager service connection in Azure ML scope and add its name into the variable group as **ML_SCOPE_SVC_CONNECTION**.
